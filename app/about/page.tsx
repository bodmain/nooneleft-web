...
export default function AboutPage() {
  ...
  const whyJoin = [
    {
      ...
      desc: "Mỗi hành động nhỏ đều góp phần thay đổi cộng đồng.",
    },
    {
      icon: Star,
      title: "Truyền cảm hứng",
      desc: "Bạn không chỉ giúp người khác mà còn trở thành tấm gương tích cực.",
    },
    {
      icon: HandCoins,
      title: "Kết nối cộng đồng",
      desc: "Gặp gỡ những người cùng chí hướng, xây dựng mạng lưới thiện nguyện.",
    },
    {
      icon: GraduationCap,
      title: "Phát triển bản thân",
      desc: "Học cách kiên nhẫn, đồng cảm, và sáng tạo trong hành động.",
    },
  ];
  ...
  const finances = [
    ...
    {
      icon: HandCoins,
      label: "Hành chính & vận hành",
      value: 10,
      color: "from-yellow-400 to-amber-300",
    },
    {
      icon: GraduationCap,
      label: "Giáo dục & hỗ trợ",
      value: 5,
    ...
    <div className="pt-0">
      ...
      <section className="relative flex flex-col justify-center items-center text-center text-white h-[70vh] overflow-hidden">
        ...
        <div className="relative z-10 px-6 max-w-3xl">
          ...
          >
            ...
            <br />
            Chúng tôi lan tỏa những câu chuyện tích cực và phát triển các dự án
        ...
        >
          ...
          <div>
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              Mọi hành trình ý nghĩa đều bắt đầu từ một khoảnh khắc nhỏ. Với
              NoOneLeft, đó là khi chúng tôi gặp một bạn trẻ khuyết tật trong
              chuyến thiện nguyện vùng cao — người đã lan tỏa năng lượng tích
              cực bằng nụ cười và sự kiên cường của mình.
            </p>

            <p className="text-gray-700 text-lg leading-relaxed mb-8">
              Từ khoảnh khắc ấy, chúng tôi nhận ra:{" "}
              <span className="font-semibold text-orange-600">
                thiện nguyện không chỉ là cho đi, mà còn là cùng nhau truyền cảm
                hứng để không ai bị bỏ lại phía sau.
              </span>
            </p>
      ...
      <section className="py-16 bg-yellow-50">
        ...
        >
          <h2 className="text-3xl font-bold text-orange-600 mb-12">
            Tại sao nên tham gia NoOneLeft?
          </h2>
      ...
      <section className="py-20 bg-gradient-to-t from-white to-[#f9f9f9]">
        ...
        <p className="text-center text-lg text-gray-700 mb-12">
          Chúng tôi tự hào khi có sự đồng hành của các đối tác chiến lược, những
          người đã hỗ trợ chúng tôi trên hành trình phát triển và mang lại giá
          trị cho cộng đồng.
        </p>
